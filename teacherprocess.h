...
public:
    ...
    //私发文字
    bool SendPrivateChat(const QString& ChatStr,const unsigned int& ReceiverNum);
    ...
    //服务端（供QuizProcess获取连接）
    Server* pServer;

    void RecvAttention(const unsigned int& Idx,const Message& Msg);

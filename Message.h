...
public:
    ...
    static Message FromAttention(const string& aAttention);
    static Message FromQuiz(const string& aQuestionAndOptions);
    ...
    static string ToQuiz(const Message& Msg);
    static string ToAttention(const Message& Msg);
